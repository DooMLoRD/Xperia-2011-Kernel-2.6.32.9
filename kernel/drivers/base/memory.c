...
static ssize_t
print_low_power_memory_size(struct class *class, char *buf)
{
...
static ssize_t
print_low_power_memory_start(struct class *class, char *buf)
{
...
static ssize_t
memory_active_store(struct class *class, const char *buf, size_t count)
{
	u64 phys_addr;
	int ret;
